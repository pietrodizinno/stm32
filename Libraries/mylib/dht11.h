...
#define GPIO_SET_AS_OUTPUT  Gpio_SetPinAsOutput(GPIOE, GPIO_PIN3, GPIO_SPEED_2MHZ, GPIO_GP_PUSH_PULL)
#define GPIO_SET_AS_INPUT   Gpio_SetPinAsInput(GPIOE, GPIO_PIN3, GPIO_FLOATING_IN)
#define GPIO_OUPUT_CLEAR    Gpio_ClearOutputPin(GPIOE, GPIO_PIN3)   /* clear port state */
#define GPIO_OUTPUT_SET     Gpio_SetOutputPin(GPIOE, GPIO_PIN3)     /* set port state to 1 */
#define GPIO_INPUT_GET      Gpio_GetInputPinValue(GPIOE, GPIO_PIN3) /* should return 0 or 1 */
